...
class nmt_dynet:
    ...
    def __init__(self, src_vocab_size, tgt_vocab_size, src_word2idx, src_idx2word, tgt_word2idx, tgt_idx2word, word_d, gru_d, gru_layers):
        ...
        # attention weights
#         self.model.add_parameters("attention_w1", (2 * self.gru_d, 2 * self.gru_d))
#         self.model.add_parameters("attention_w2", (2 * self.gru_d, self.gru_d))
#         self.model.add_parameters("attention_v", (1, 2 * self.gru_d))
...
#         print src_sentence
    ...
    def get_loss(self, src_sentence, tgt_sentence):
        ...
        encoded_string = self._encode_string(src_sentence)[-1]

        # print encoded_string.npvalue().shape
        ...
        for i in xrange(len(tgt_sentence)):
            w_id = tgt_sentence[i]
            rnn_state = rnn_state.add_input(concatenate([prev_word_emb, encoded_string]))
